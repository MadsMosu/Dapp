...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ethers__ = __webpack_require__("./node_modules/ethers/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_configs_provider__ = __webpack_require__("./utils/configs/provider.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_configs_network__ = __webpack_require__("./utils/configs/network.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_admin_Layout__ = __webpack_require__("./components/admin/Layout.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_react_apollo__ = __webpack_require__("./node_modules/react-apollo/react-apollo.browser.umd.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__lib_withData__ = __webpack_require__("./lib/withData.js");

var _jsxFileName = 'C:\\Users\\Mads\\Documents\\Bachelor\\Dapp\\pages\\admin\\transfer.js';
...
var transfer = function (_Component) {
    ...
    function transfer() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = transfer.__proto__ || Object.getPrototypeOf(transfer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            selectorValue: "",
            amount: "",
            errorMessage: "",
            loading: false,
            ...
            var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(event) {
                var adminWallet, EmployeeStore, employee;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                //blockchain
                                adminWallet = new __WEBPACK_IMPORTED_MODULE_2_ethers___default.a.Wallet(_this.props.data.employee.privateKey, __WEBPACK_IMPORTED_MODULE_3__utils_configs_provider__["a" /* default */]);
                                EmployeeStore = new __WEBPACK_IMPORTED_MODULE_2_ethers___default.a.Contract(__WEBPACK_IMPORTED_MODULE_6__utils_addresses_employeeStore__["a" /* default */], __WEBPACK_IMPORTED_MODULE_5__utils_abi_employeeStore___default.a, adminWallet);
                                _context.next = 6;
                                return EmployeeStore.functions.getEmployeeByEmployeeID(_this.state.selectorValue).then(function (result) {
                                    employee = result;
                                });

                            case 6:
                                _context.next = 8;
                                return adminWallet.send(employee[0], __WEBPACK_IMPORTED_MODULE_2_ethers___default.a.utils.parseEther(_this.state.amount));
    ...
    _createClass(transfer, [{
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                __WEBPACK_IMPORTED_MODULE_8__components_admin_Layout__["a" /* default */],
                {
                    __source: {
                        fileName: _jsxFileName,
                        lineNumber: 74
                ...
                __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                    __WEBPACK_IMPORTED_MODULE_7_semantic_ui_react__["d" /* Form */],
                    ...
                    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                        __WEBPACK_IMPORTED_MODULE_7_semantic_ui_react__["d" /* Form */].Field,
                        { inline: true, __source: {
                                fileName: _jsxFileName,
                                lineNumber: 77
                            }
                        },
                        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_semantic_ui_react__["c" /* Dropdown */], { name: 'selectorValue', placeholder: 'Select Employee', search: true, selection: true, options: this.state.options, required: true, onChange: this.handleChange, __source: {
                                fileName: _jsxFileName,
                                lineNumber: 78
                            }
                        })
                    ...
                    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_semantic_ui_react__["f" /* Input */], { label: 'Amount in Ether', placeholder: 'Amount', value: this.state.name, required: true, onChange: function onChange(event) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_semantic_ui_react__["h" /* Message */], { error: true, header: 'Error!', content: this.state.errorMessage, __source: {
                            fileName: _jsxFileName,
                            lineNumber: 84
                        }
                    }),
                    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                        __WEBPACK_IMPORTED_MODULE_7_semantic_ui_react__["a" /* Button */],
        ...
        value: function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2() {
                var adminWallet, EmployeeStore, count, employees, _i, employeeOptions, i;

                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                adminWallet = new __WEBPACK_IMPORTED_MODULE_2_ethers___default.a.Wallet("0xcc213ad8f9f68662570d16bc20be6662f86477e3e7edd3b140b007bca44c6186", __WEBPACK_IMPORTED_MODULE_3__utils_configs_provider__["a" /* default */]);
                                EmployeeStore = new __WEBPACK_IMPORTED_MODULE_2_ethers___default.a.Contract(__WEBPACK_IMPORTED_MODULE_6__utils_addresses_employeeStore__["a" /* default */], __WEBPACK_IMPORTED_MODULE_5__utils_abi_employeeStore___default.a, adminWallet);
                                count = void 0;
                                _context2.next = 5;
                            ...
                            case 7:
                                ...
                                _context2.next = 10;
                                return EmployeeStore.getEmployeeByIndex(_i).then(function (result) {
                            ...
                            case 13:
                                ...
                                return _context2.abrupt('return', { employees: employees, employeeOptions: employeeOptions });
...
var employee = __WEBPACK_IMPORTED_MODULE_10_graphql_tag___default()(_templateObject);

var _default = Object(__WEBPACK_IMPORTED_MODULE_11__lib_withData__["a" /* default */])(Object(__WEBPACK_IMPORTED_MODULE_9_react_apollo__["graphql"])(employee, {
    options: {
...
(function () {
    ...
    reactHotLoader.register(transfer, 'transfer', 'C:/Users/Mads/Documents/Bachelor/Dapp/pages/admin/transfer.js');
    reactHotLoader.register(employee, 'employee', 'C:/Users/Mads/Documents/Bachelor/Dapp/pages/admin/transfer.js');
    reactHotLoader.register(_default, 'default', 'C:/Users/Mads/Documents/Bachelor/Dapp/pages/admin/transfer.js');
    leaveModule(module);
})();
...
;
    ...
    })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), "/admin\\transfer")
...
//# sourceMappingURL=5.dff89b2ee4defda1d464.hot-update.js.map