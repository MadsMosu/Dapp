    ...
    _createClass(BloodSampleRow, [{
        ...
        value: function renderStorage() {
            if (this.props.donation.inStorage == true) {
                return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_semantic_ui_react__["f" /* Icon */], { color: 'green', name: 'checkmark', size: 'large', __source: {
                        fileName: _jsxFileName,
                        lineNumber: 38
                    }
                });
            } else {
                return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_semantic_ui_react__["f" /* Icon */], { color: 'red', name: 'close', size: 'large', __source: {
                        fileName: _jsxFileName,
                        lineNumber: 42
                    }
                });
...
//# sourceMappingURL=3.c62f8074c74d992cebda.hot-update.js.map