...
/***/ "./components/admin/EmployeeForm.js":
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_abi_employeeStore__ = __webpack_require__("./utils/abi/employeeStore.json");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_abi_employeeStore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__utils_abi_employeeStore__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__utils_addresses_employeeStore__ = __webpack_require__("./utils/addresses/employeeStore.js");
...
var _jsxFileName = 'C:\\Users\\Mads\\Documents\\Bachelor\\Dapp\\components\\admin\\EmployeeForm.js';
...
var EmployeeForm = function (_Component) {
    ...
    function EmployeeForm() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EmployeeForm.__proto__ || Object.getPrototypeOf(EmployeeForm)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            name: "",
            employeeID: "",
            errorMessage: "",
            loading: false
            ...
            var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(event) {
                var adminWallet, newEmployeeWallet, EmployeeStore;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                //blockchain
                                adminWallet = new __WEBPACK_IMPORTED_MODULE_3_ethers___default.a.Wallet(_this.props.data.employee.privateKey, __WEBPACK_IMPORTED_MODULE_4__utils_configs_provider__["a" /* default */]);
                                newEmployeeWallet = __WEBPACK_IMPORTED_MODULE_3_ethers___default.a.Wallet.createRandom();
                                EmployeeStore = new __WEBPACK_IMPORTED_MODULE_3_ethers___default.a.Contract(__WEBPACK_IMPORTED_MODULE_7__utils_addresses_employeeStore__["a" /* default */], __WEBPACK_IMPORTED_MODULE_6__utils_abi_employeeStore___default.a, adminWallet);
                                _context.next = 7;
                                return adminWallet.send(newEmployeeWallet.address, __WEBPACK_IMPORTED_MODULE_3_ethers___default.a.utils.parseEther('1.0'));

                            case 7:
                                _context.next = 9;
                                return EmployeeStore.functions.newEmployee(newEmployeeWallet.address, _this.state.name, _this.state.employeeID);
            ...
            return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_semantic_ui_react__["g" /* Input */], { label: 'Name', placeholder: 'Name', value: this.state.name, required: true, onChange: function onChange(event) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_semantic_ui_react__["g" /* Input */], { label: 'Employee ID', placeholder: 'Employee ID', value: this.state.employeeID, required: true, onChange: function onChange(event) {
                                return _this3.setState({ employeeID: event.target.value });
                            }, __source: {
                                fileName: _jsxFileName,
                                lineNumber: 54
                            }
...
var createEmployee = __WEBPACK_IMPORTED_MODULE_9_graphql_tag___default()(_templateObject);

var employee = __WEBPACK_IMPORTED_MODULE_9_graphql_tag___default()(_templateObject2);

var _default = Object(__WEBPACK_IMPORTED_MODULE_8_react_apollo__["compose"])(Object(__WEBPACK_IMPORTED_MODULE_8_react_apollo__["graphql"])(createEmployee), Object(__WEBPACK_IMPORTED_MODULE_8_react_apollo__["graphql"])(employee, {
    options: {
...
(function () {
    ...
    reactHotLoader.register(EmployeeForm, 'EmployeeForm', 'C:/Users/Mads/Documents/Bachelor/Dapp/components/admin/EmployeeForm.js');
    reactHotLoader.register(createEmployee, 'createEmployee', 'C:/Users/Mads/Documents/Bachelor/Dapp/components/admin/EmployeeForm.js');
    reactHotLoader.register(employee, 'employee', 'C:/Users/Mads/Documents/Bachelor/Dapp/components/admin/EmployeeForm.js');
    reactHotLoader.register(_default, 'default', 'C:/Users/Mads/Documents/Bachelor/Dapp/components/admin/EmployeeForm.js');
    leaveModule(module);
})();
...
//# sourceMappingURL=6.462dd8382781104883b2.hot-update.js.map